...
**DRAFT IN PROGRESS.** There is an open RFC for the high level networking design - [RFC 07 - High Level Network Architecture for OpenShift](https://docs.google.com/document/d/1pW9P7jLs6QAOVVLIys5vmcHClthTqWzNSlI5lXA1Ca8/edit?usp=sharing)
...
See the [forked Autoshift documentation](/docs/README_AUTOSHIFT.md) for details.
